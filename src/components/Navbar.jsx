    ...
    return (
        <nav className={ "p-2 sticky w-full z-20 top-0 start-0 border-b border-gray-600 bg-[" + Colors.dark_color + "]" }>
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className={ "items-center justify-between w-full md:flex md:w-auto md:order-1 " + ( isCollapsed ? "hidden" : "" ) } id="navbar-sticky">
